  ...
  <div class="box">
    <el-form ref="formInline" :model="formInline" :rules="formInline" :inline="true" class="merchantSubAcount">
      ...
      <el-form-item class="submit">
        ...
        <el-button type="success" @click="addClass"><i class="el-icon-plus" />商品分类</el-button>
      </el-form-item>
    </el-form>
    <!-- 表格数据 -->
    ...
    <el-dialog :visible.sync="iv_dialog.show" :title="iv_dialog.title">
      <el-form ref="addForm" :model="addForm" status-icon label-width="100px">
        ...
        <el-form-item label="父级分类选择:">
          <el-select v-if="classTop && classTop.length>0" v-model="addForm.parent_cat_id" placeholder="选择父级分类">
            <el-option label="不选择" value=""></el-option>
            <el-option v-for="i in classTop" :key="i.id" :label="i.category_name" :value="i.id"></el-option>
          </el-select>
        </el-form-item>
